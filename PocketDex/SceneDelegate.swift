...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    // user data (theme and version settings)
    var selectedTheme = UserTheme(themeIndex: 0)
    var selectedVersion = UserVersion(versionName: "Ultra Sun & Ultra Moon", versionGen: 7, versionOrder: 17)
